...
function KpiCategoriesPage() {
  const data = [
    { id: "1", name: "Productivity", code: "PROD", desc: "Productivity metrics" },
    { id: "2", name: "Quality", code: "QUAL", desc: "Quality metrics" },
    { id: "3", name: "Efficiency", code: "EFF", desc: "Efficiency metrics" },
    { id: "4", name: "Customer", code: "CUST", desc: "Customer metrics" },
    { id: "5", name: "Financial", code: "FIN", desc: "Financial metrics" },
  ];
  return (
    <div>
      <PageHeader
