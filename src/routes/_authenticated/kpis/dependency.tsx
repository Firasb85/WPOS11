...
export const Route = createFileRoute("/_authenticated/kpis/dependency")({ component: KpisDependencyPage });

function KpisDependencyPage() {
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"}>
      <PageHeader title="KPI Dependencies" titleAr="تبعيات المؤشرات" description="Map relationships between KPIs" descriptionAr="تخطيط العلاقات بين المؤشرات" currentLang={lang} />
      ...
      <Card>
        <CardHeader><CardTitle>{t("KPI Dependencies","تبعيات المؤشرات")}</CardTitle></CardHeader>
        <div className="p-5">
          {items.length === 0 ? (
