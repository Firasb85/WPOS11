        ...
        <div className="lg:col-span-1">
          <DataTable
            columns={[
              ...
              { key: "code", label: "Code" },
              { key: "target", label: "Target", render: (i) => `${i.target}${i.unit}` },
            ]}
            data={kpis}
        ...
        <div className="lg:col-span-2">
          {sel ? (
              ...
              <Card>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="text-sm font-medium font-mono">{sel.code}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500">Category</p>
                    <p className="text-sm font-medium">{sel.category}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500">Unit</p>
                    <p className="text-sm font-medium">{sel.unit}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium capitalize">{sel.freq}</p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm font-medium flex items-center gap-1">
                      {sel.higher ? (
                        <>
                          <TrendingUp className="w-4 h-4 text-green-500" /> Higher Better
                        </>
                      ) : (
                        <>
                          <TrendingDown className="w-4 h-4 text-red-500" /> Lower Better
                        </>
                      )}
                    </p>
                  </div>
            ...
            <div className="flex items-center justify-center h-64 text-gray-400">
              <p>Select a KPI to view details</p>
            </div>
          )}
        </div>
      </div>
