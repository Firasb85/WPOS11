...
function JobFamiliesPage() {
  const data = [
    { id: "1", name: "Engineering", code: "ENG", desc: "Engineering roles" },
    { id: "2", name: "Finance & Accounting", code: "FIN", desc: "Finance roles" },
    { id: "3", name: "Human Resources", code: "HR", desc: "HR roles" },
  ];
  return (
    <div>
      <PageHeader
        title="Job Families"
        description="Manage job families"
        actions={
