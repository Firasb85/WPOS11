...
export const Route = createFileRoute("/_authenticated/dashboards/process-intelligence")({ component: DashboardsProcess_intelligencePage });

function DashboardsProcess_intelligencePage() {
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"}>
      ...
      <Card>
        <CardHeader><CardTitle>{t("Process Intelligence","ذكاء العمليات")}</CardTitle></CardHeader>
        <div className="p-5">
          {items.length === 0 ? (
