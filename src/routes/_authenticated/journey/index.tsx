...
function JourneyPage() {
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"}>
      <PageHeader title="Performance Journey" titleAr="رحلة الأداء" description="Track employee performance journey" descriptionAr="تتبع رحلة أداء الموظف" currentLang={lang} />
      ...
      <Card>
        <CardHeader><CardTitle>{t("Performance Journey","رحلة الأداء")}</CardTitle></CardHeader>
        <div className="p-5">
          {items.length === 0 ? (
