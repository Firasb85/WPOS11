        ...
        <div className="space-y-4">
          <div className="p-4 bg-white rounded-xl border">
            ...
            <div className="grid grid-cols-3 gap-3">
              <button className="flex flex-col items-center gap-2 p-4 border rounded-lg hover:border-blue-500 hover:bg-blue-50">
          ...
          <button className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-blue-600 text-white rounded-lg text-sm font-medium">
