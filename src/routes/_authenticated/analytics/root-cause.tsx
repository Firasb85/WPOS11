...
export const Route = createFileRoute("/_authenticated/analytics/root-cause")({ component: AnalyticsRoot_causePage });

function AnalyticsRoot_causePage() {
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"}>
      <PageHeader title="Root Cause Analysis" titleAr="تحليل الأسباب الجذرية" description="Deep analysis of performance root causes" descriptionAr="تحليل عميق لأسباب الأداء الجذرية" currentLang={lang} />
      ...
      <Card>
        <CardHeader><CardTitle>{t("Root Cause Analysis","تحليل الأسباب الجذرية")}</CardTitle></CardHeader>
        <div className="p-5">
          {items.length === 0 ? (
