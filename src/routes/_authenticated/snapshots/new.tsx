...
function NewSnapshotPage() {
  return (
    <div>
      <PageHeader title="Record Snapshot" description="Record actual performance results" />
      <div className="max-w-2xl">
        <Card>
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1.5">KPI *</label>
              <select className="w-full px-3 py-2.5 rounded-lg border border-gray-300 bg-white text-sm">
            ...
            <div>
              <label className="block text-sm font-medium mb-1.5">Actual *</label>
              <input
                type="number"
                className="w-full px-3 py-2.5 rounded-lg border border-gray-300 text-sm"
              />
            ...
            <div>
              ...
              <textarea className="w-full px-3 py-2.5 rounded-lg border border-gray-300 text-sm min-h-[80px]" />
            </div>
          </div>
