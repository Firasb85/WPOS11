      ...
      fallback={(error, reset) => (
        <div className="flex min-h-[60vh] items-center justify-center p-8">
          <div className="max-w-md text-center">
            <h2 className="text-xl font-semibold text-foreground">This page couldn&apos;t load</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              There was a problem loading the {pageName} page. You can try again or navigate
              elsewhere.
            </p>
            {import.meta.env.DEV && (
